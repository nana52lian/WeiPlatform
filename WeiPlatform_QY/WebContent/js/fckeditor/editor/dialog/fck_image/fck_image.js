...
function OnUploadCompleted( errorNumber, fileUrl, fileName, customMsg )
{
	...
	switch ( errorNumber )
    {
        case 0 :    // No errors
            //alert( '图片上传成功!' ) ;
            $.messager.alert("警告","图片上传成功!");
            break ;
        case 1 :    // Custom error
            //alert( customMsg ) ;
            $.messager.alert("警告",customMsg);
            return ;
        ...
        case 204 :
            //alert( '请上传500K以内的图片!' ) ;
            $.messager.alert("警告","请上传500K以内的图片!");
            break ;
        case 201 :
            //alert( '已存在同名文件.刚才上传的文件已自动重命名为: "' + fileName + '"' ) ;
            $.messager.alert("警告",'已存在同名文件.刚才上传的文件已自动重命名为: "' + fileName + '"');
            break ;
        case 202 :
            //alert( '不支持此文件格式!' ) ;
            $.messager.alert("警告","不支持此文件格式!");
            return ;
        case 203 :
            //alert( '您可能没有足够的权限上传文件,请检查服务器设置!' ) ;
            $.messager.alert("警告","您可能没有足够的权限上传文件,请检查服务器设置!");
            return ;
        case 500 :
            //alert( '连接被禁用!' ) ;
            $.messager.alert("警告","连接被禁用");
            break ;
        default :
            //alert( '文件上传失败.错误号: ' + errorNumber ) ;
        	$.messager.alert("警告",'文件上传失败.错误号: ' + errorNumber);
            return ;
    }
